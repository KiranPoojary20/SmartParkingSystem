...
// Create connection for supervisor details
...
// Fetch supervisor details based on username
$username = $_SESSION['username'];
$stmt = $conn->prepare("SELECT supervisor_name FROM parking_supervisors WHERE username = ?");
$stmt->bind_param("s", $username);
$stmt->execute();
$result = $stmt->get_result();

$supervisor_name = "Supervisor"; // Default fallback
...
<head>
    ...
    <style>
        /* Entire style section from the previous live_parking.php file */
        :root {
        ...
        * {
        ...
        .dashboard-container {
    margin-top: 70px;
    height: calc(100vh - 70px); /* Adjust to full viewport height minus topbar height */
...
<body>
    <div class="topbar">
        <div class="topbar-left">
            ...
            <div id="supervisorGreeting" class="supervisor-greeting">
    ...
    <script>
        // Add supervisor greeting functionality
        document.addEventListener('DOMContentLoaded', function() {
            const supervisorGreeting = document.getElementById('supervisorGreeting');
            ...
            // Prepend the greeting to the existing name
            supervisorGreeting.textContent = `${greeting}, ${supervisorGreeting.textContent}`;
        });
