...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username) || empty($password)) {
        ...
        $stmt = $conn->prepare("SELECT password FROM parking_supervisors WHERE username = ?");
        ...
        if ($result->num_rows == 1) {
            ...
            // Note: If you're migrating from plain text, you'll need to update the passwords
...
<head>
    ...
    <title>Smart Parking System - Parking Supervisor Login</title>
    <style>
...
<div class="login-container">
    <h1>Parking Supervisor Login</h1>
    
    <?php
    if (!empty($error_message)) {
        echo "<div class='error-message show'>" . htmlspecialchars($error_message) . "</div>";
    }
    ?>
    ...
    <script>
        ...
        function showNotification(message, type) {
            ...
            if (Notification.permission === "granted") {
                ...
                var notification = new Notification("Parking Supervisor System", {
                    body: message,
